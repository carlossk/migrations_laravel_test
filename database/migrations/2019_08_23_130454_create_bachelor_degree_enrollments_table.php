...
class CreateBachelorDegreeEnrollmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bachelor_degree_enrollments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bachelor_degree_enrollments');
    }
}
